...
const [, , httpAdminRoot, httpNodeRoot, userDir] = process.argv;

// Create the settings object based on command-line arguments
const settings = {
    httpAdminRoot: httpAdminRoot || "/red",
    httpNodeRoot: httpNodeRoot || "/api",
    httpNodeCors: true,
    userDir: userDir || "/home/nol/.nodered/",
...
server.listen(0,() => {
    ...
    console.log("Node-RED URL:", `http://${serverAddress.address}:${serverPort}${settings.httpAdminRoot}`);
